...
export default function Footer() {
  return (
    <div className=" pt-4 sm:pt-10 lg:pt-12 font-spartan">
      <footer className="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 border-t gap-12 lg:gap-8 pt-10 lg:pt-12 mb-16">
          <div className="col-span-full lg:col-span-2">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                target="_blank"
                className="text--400 hover:text--500 active:text--600 transition duration-100"
              >
                <svg
                  className="w-5 h-5"
                  width="24"
          ...
          <div>
            <div className="text--800 font-bold tracking-widest uppercase mb-4">
              Products
            </div>
            ...
            <nav className="flex flex-col gap-4">
              <div>
                <a
                  href="#"
                  className="text--500 hover:text-indigo-500 active:text-indigo-600 transition duration-100"
                >
                  Overview
                </a>
              </div>
