...
export default function NavComponent() {
  ...
  return (
    <div className="sticky top-0 font-orbitron z-10 backdrop-blur-sm  text-xl font-bold drop-shadow-xl flex-none transition-colors duration-500  ">
          ...
          <div className="flex justify-between items-center   py-6 sm:justify-between sm:space-x-10">
            <div className="flex justify-start lg:w-0 lg:flex-1">
              <Link href="#home" passHref>
                <h1 className="">
                  Galactic<span>Collectibles</span>
                </h1>
              </Link>
            </div>
