  ...
  return (
    <div className="container mx-auto py-10 flex flex-wrap justify-around items-center px-4">
      <div className="max-w-2xl ">
        <div className="text-left">
          <h1 className="font-spartan font-bold text-6xl">
           Explore, share, and monetize discoveries via {" "}
          ...
          The platform blends blockchain, community collaboration, and education for a thriving amateur astronomy ecosystem.{" "}
          </p>
      ...
      <div className="flex-end">
        <img src="/Mustafar.jpg" alt="apes" className="rounded-3xl" />
